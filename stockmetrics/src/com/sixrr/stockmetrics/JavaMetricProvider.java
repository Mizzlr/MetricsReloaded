...
public class JavaMetricProvider implements MetricProvider {
    ...
    private static void initializeMethodMetrics(Collection<Metric> metrics) {
        ...
        metrics.add(new ProgrammerEfficiencyMethodMetric());
    ...
    public List<PrebuiltMetricProfile> getPrebuiltProfiles() {
        final List<PrebuiltMetricProfile> out = new ArrayList<PrebuiltMetricProfile>(13);
    ...
    private static PrebuiltMetricProfile createBuggyProfile() {
        final PrebuiltMetricProfile profile =
                new PrebuiltMetricProfile("Buggy metrics");
        profile.addMetric(NumTimesCalledMetric.class);
        profile.addMetric(NumTimesCalledProductMetric.class);
        profile.addMetric(NumTimesCalledTestMetric.class);
        return profile;
    }
    private static PrebuiltMetricProfile createOtherProfile() {
        final PrebuiltMetricProfile profile =
                new PrebuiltMetricProfile(StockMetricsBundle.message("other.metrics.profile.name"));
        profile.addMetric(AdjustedLevelOrderClassMetric.class);
        profile.addMetric(AdjustedLevelOrderInterfaceMetric.class);
        profile.addMetric(AdjustedLevelOrderPackageMetric.class);
        ...
        profile.addMetric(CommentLinesOfCodeInterfaceMetric.class);
        profile.addMetric(CommentLinesOfCodeMethodMetric.class);
        profile.addMetric(CommentLinesOfCodePackageMetric.class);
        profile.addMetric(CommentLinesOfCodeRecursivePackageMetric.class);
        profile.addMetric(CommentRatioClassMetric.class);
        profile.addMetric(CommentRatioInterfaceMetric.class);
        profile.addMetric(CommentRatioMethodMetric.class);
        profile.addMetric(CommentRatioPackageMetric.class);
        profile.addMetric(CommentRatioRecursivePackageMetric.class);
        profile.addMetric(ConditionalNestingDepthMetric.class);
        profile.addMetric(ControlDensityMetric.class);
        profile.addMetric(CouplingBetweenObjectsInterfaceMetric.class);
        profile.addMetric(EncapsulationRatioModuleMetric.class);
        ...
        profile.addMetric(InterfaceSizeAttributesMetric.class);
        profile.addMetric(InterfaceSizeOperationsAttributesMetric.class);
        profile.addMetric(InterfaceSizeOperationsMetric.class);
        profile.addMetric(JavadocLinesOfCodeRecursivePackageMetric.class);
        profile.addMetric(LevelOrderClassMetric.class);
        profile.addMetric(LevelOrderInterfaceMetric.class);
        profile.addMetric(LevelOrderPackageMetric.class);
        profile.addMetric(LinesOfCodeClassMetric.class);
        profile.addMetric(LinesOfCodeInterfaceMetric.class);
        ...
        profile.addMetric(NumAbstractClassesModuleMetric.class);
        profile.addMetric(NumAbstractClassesPackageMetric.class);
        profile.addMetric(NumAbstractClassesProjectMetric.class);
        profile.addMetric(NumAbstractClassesRecursivePackageMetric.class);
        profile.addMetric(NumAnnotationClassesModuleMetric.class);
        profile.addMetric(NumAnnotationClassesPackageMetric.class);
        profile.addMetric(NumAnnotationClassesProjectMetric.class);
        profile.addMetric(NumAnnotationClassesRecursivePackageMetric.class);
        profile.addMetric(NumAnonymousClassesPackageMetric.class);
        profile.addMetric(NumAssertsMetric.class);
        profile.addMetric(NumAttributesAddedMetric.class);
        profile.addMetric(NumAttributesInheritedMetric.class);
        profile.addMetric(NumBranchStatementsMetric.class);
        profile.addMetric(NumCommandsClassMetric.class);
        profile.addMetric(NumCommandsInterfaceMetric.class);
        profile.addMetric(NumConcreteClassesModuleMetric.class);
        profile.addMetric(NumConcreteClassesPackageMetric.class);
        profile.addMetric(NumConcreteClassesProjectMetric.class);
        profile.addMetric(NumConcreteClassesRecursivePackageMetric.class);
        profile.addMetric(NumConstructorsMetric.class);
        profile.addMetric(NumControlStatementsMetric.class);
        profile.addMetric(NumCyclicDependenciesPackageMetric.class);
        profile.addMetric(NumEnumClassesModuleMetric.class);
        profile.addMetric(NumEnumClassesPackageMetric.class);
        profile.addMetric(NumEnumClassesProjectMetric.class);
        profile.addMetric(NumEnumClassesRecursivePackageMetric.class);
        profile.addMetric(NumExceptionsCaughtMetric.class);
        profile.addMetric(NumExceptionsThrownMetric.class);
        profile.addMetric(NumExecutableStatementsMetric.class);
        profile.addMetric(NumExpressionsMetric.class);
        profile.addMetric(NumImplementationsMethodMetric.class);
        profile.addMetric(NumImplementationsMetric.class);
        profile.addMetric(NumInnerClassesMetric.class);
        profile.addMetric(NumInterfacesImplementedMetric.class);
        profile.addMetric(NumInterfacesModuleMetric.class);
        profile.addMetric(NumInterfacesPackageMetric.class);
        profile.addMetric(NumInterfacesProjectMetric.class);
        profile.addMetric(NumInterfacesRecursivePackageMetric.class);
        profile.addMetric(NumLambdasPackageMetric.class);
        profile.addMetric(NumLeafClassesModuleMetric.class);
        profile.addMetric(NumLeafClassesPackageMetric.class);
        profile.addMetric(NumLeafClassesProjectMetric.class);
        profile.addMetric(NumLeafClassesRecursivePackageMetric.class);
        profile.addMetric(NumLoopsMetric.class);
        profile.addMetric(NumMethodCallsMetric.class);
        profile.addMetric(NumMethodsModuleMetric.class);
        profile.addMetric(NumMethodsPackageMetric.class);
        profile.addMetric(NumMethodsProjectMetric.class);
        profile.addMetric(NumMethodsRecursivePackageMetric.class);
        profile.addMetric(NumNullChecksMetric.class);
        ...
        profile.addMetric(NumOverridesMethodMetric.class);
        profile.addMetric(NumPackageDependenciesClassMetric.class);
        profile.addMetric(NumPackageDependenciesInterfaceMetric.class);
        profile.addMetric(NumPackageDependentsClassMetric.class);
        profile.addMetric(NumPackageDependentsInterfaceMetric.class);
        profile.addMetric(NumPackagesMetric.class);
        profile.addMetric(NumParametersMetric.class);
        profile.addMetric(NumQueriesClassMetric.class);
        profile.addMetric(NumQueriesInterfaceMetric.class);
        profile.addMetric(NumReturnPointsMetric.class);
        profile.addMetric(NumRootClassesModuleMetric.class);
        profile.addMetric(NumRootClassesPackageMetric.class);
        profile.addMetric(NumRootClassesProjectMetric.class);
        profile.addMetric(NumRootClassesRecursivePackageMetric.class);
        profile.addMetric(NumStatementsClassMetric.class);
        profile.addMetric(NumStatementsMetric.class);
        profile.addMetric(NumSubclassesMetric.class);
        profile.addMetric(NumSubinterfacesMetric.class);
        profile.addMetric(NumTestAssertsRecursivePackageMetric.class);
        profile.addMetric(NumTestCasesRecursivePackageMetric.class);
        profile.addMetric(NumTestMethodsRecursivePackageMetric.class);
//        profile.addMetric(NumTimesCalledMetric.class);
//        profile.addMetric(NumTimesCalledProductMetric.class);
//        profile.addMetric(NumTimesCalledTestMetric.class);
        profile.addMetric(NumTopLevelClassesModuleMetric.class);
        profile.addMetric(NumTopLevelClassesPackageMetric.class);
        profile.addMetric(NumTopLevelClassesProjectMetric.class);
        profile.addMetric(NumTopLevelClassesRecursivePackageMetric.class);
        profile.addMetric(NumTopLevelInterfacesModuleMetric.class);
        profile.addMetric(NumTopLevelInterfacesPackageMetric.class);
        profile.addMetric(NumTopLevelInterfacesProjectMetric.class);
        profile.addMetric(NumTopLevelInterfacesRecursivePackageMetric.class);
        profile.addMetric(NumTransitiveDependencyPackagesPackageMetric.class);
        profile.addMetric(NumTransitiveDependentPackagesPackageMetric.class);
        profile.addMetric(NumTypeParametersClassMetric.class);
        profile.addMetric(NumTypeParametersInterfaceMetric.class);
        profile.addMetric(NumTypeParametersMetric.class);
        profile.addMetric(NumTypecastExpressionsMetric.class);
        profile.addMetric(PercentClassesJavadocedRecursivePackageMetric.class);
        profile.addMetric(PercentFieldsJavadocedRecursivePackageMetric.class);
        profile.addMetric(PercentMethodsJavadocedRecursivePackageMetric.class);
        ...
        profile.addMetric(RelativeLinesOfCodeMetric.class);
        ...
        profile.addMetric(TestRatioPackageMetric.class);
        profile.addMetric(TodoCommentCountClassMetric.class);
        profile.addMetric(TodoCommentCountInterfaceMetric.class);
        profile.addMetric(TodoCommentCountMethodMetric.class);
        profile.addMetric(TodoCommentCountPackageMetric.class);
        profile.addMetric(TodoCommentCountRecursivePackageMetric.class);
        profile.addMetric(TrueCommentRatioClassMetric.class);
        profile.addMetric(TrueCommentRatioInterfaceMetric.class);
        profile.addMetric(TrueCommentRatioMethodMetric.class);
        profile.addMetric(TrueCommentRatioPackageMetric.class);
        profile.addMetric(TrueCommentRatioRecursivePackageMetric.class);
    ...
    private static PrebuiltMetricProfile createAllProfile() {
        ...
        profile.addMetric(EssentialCyclomaticComplexityMetric.class);
        profile.addMetric(HalsteadBugsMethodMetric.class);
        profile.addMetric(HalsteadDifficultyMethodMetric.class);
        profile.addMetric(HalsteadEffortMethodMetric.class);
        profile.addMetric(HalsteadLengthMethodMetric.class);
...
//        profile.addMetric(NumTimesCalledTestMetric.class);
        ...
        profile.addMetric(TodoCommentCountMethodMetric.class);
        profile.addMetric(TrueCommentRatioMethodMetric.class);
        profile.addMetric(AverageCyclomaticComplexityModuleMetric.class);
        profile.addMetric(EncapsulationRatioModuleMetric.class);
        profile.addMetric(JavadocLinesOfCodeModuleMetric.class);
        profile.addMetric(LinesOfJavaModuleMetric.class);
        profile.addMetric(NumAbstractClassesModuleMetric.class);
        ...
        profile.addMetric(PercentFieldsJavadocedModuleMetric.class);
        profile.addMetric(PercentMethodsJavadocedModuleMetric.class);
        profile.addMetric(TotalCyclomaticComplexityModuleMetric.class);
        profile.addMetric(AbstractnessMetric.class);
        profile.addMetric(AdjustedLevelOrderPackageMetric.class);
        profile.addMetric(AfferentCouplingMetric.class);
        profile.addMetric(AverageCyclomaticComplexityPackageMetric.class);
        profile.addMetric(CommentLinesOfCodePackageMetric.class);
        profile.addMetric(CommentLinesOfCodeRecursivePackageMetric.class);
        profile.addMetric(CommentRatioPackageMetric.class);
        profile.addMetric(CommentRatioRecursivePackageMetric.class);
        ...
        profile.addMetric(TodoCommentCountPackageMetric.class);
        profile.addMetric(TodoCommentCountRecursivePackageMetric.class);
        profile.addMetric(TotalCyclomaticComplexityPackageMetric.class);
        profile.addMetric(TrueCommentRatioPackageMetric.class);
        profile.addMetric(TrueCommentRatioRecursivePackageMetric.class);
        profile.addMetric(AttributeHidingFactorProjectMetric.class);
        profile.addMetric(AttributeInheritanceFactorProjectMetric.class);
        profile.addMetric(AverageCyclomaticComplexityProjectMetric.class);
        profile.addMetric(CouplingFactorProjectMetric.class);
        profile.addMetric(JavadocLinesOfCodeProjectMetric.class);
        profile.addMetric(LinesOfJavaProjectMetric.class);
        profile.addMetric(MethodHidingFactorProjectMetric.class);
        ...
        profile.addMetric(PercentMethodsJavadocedProjectMetric.class);
        profile.addMetric(PolymorphismFactorProjectMetric.class);
        profile.addMetric(TotalCyclomaticComplexityProjectMetric.class);
    ...
    private static PrebuiltMetricProfile createHalsteadProfile() {
        final PrebuiltMetricProfile profile =
                new PrebuiltMetricProfile(StockMetricsBundle.message("halstead.metrics.profile.name"));
        profile.addMetric(LinesOfCodeMethodMetric.class);
        profile.addMetric(CyclomaticComplexityMetric.class);
        profile.addMetric(EssentialCyclomaticComplexityMetric.class);
        profile.addMetric(DesignComplexityMetric.class);
        profile.addMetric(HalsteadLengthMethodMetric.class); // n = n1 + n2
        profile.addMetric(HalsteadVolumeMethodMetric.class);
        profile.addMetric(HalsteadEstimatedLengthMethodMetric.class); // implemented this
        profile.addMetric(HalsteadDifficultyMethodMetric.class);
        profile.addMetric(HalsteadIntelligenceMethodMetric.class); // implemented this
        profile.addMetric(HalsteadEffortMethodMetric.class);
        profile.addMetric(HalsteadBugsMethodMetric.class);
