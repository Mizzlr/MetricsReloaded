...
public class MaintainabilityIndexMethodMetric extends MethodMetric {
    ...
    public String getDisplayName() {
        return StockMetricsBundle.message("maintainability.index.display.name");
    }

    @NotNull
    @Override
    public String getAbbreviation() {
        return StockMetricsBundle.message("maintainability.index.abbreviation");
    }
    ...
    public MetricCalculator createCalculator() {
        return new MaintainabilityIndexMethodCalculator();
    }
}
