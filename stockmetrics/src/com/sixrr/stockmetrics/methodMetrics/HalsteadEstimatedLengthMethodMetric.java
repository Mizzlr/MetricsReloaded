...
public class HalsteadEstimatedLengthMethodMetric extends MethodMetric {
    ...
    public String getDisplayName() {
        return StockMetricsBundle.message("halstead.estimated.length.display.name");
    }

    @NotNull
    @Override
    public String getAbbreviation() {
        return StockMetricsBundle.message("halstead.estimated.length.abbreviation");
    }
    ...
    public MetricCalculator createCalculator() {
        return new HalsteadEstimatedLengthMethodCalculator();
    }
}